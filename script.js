...
var character = {
    "chr": [{
        ...
        info_size: [-2, 40, 100],
        pos_info: [75, 41],
        text_to_next: "คุณมาถูกทางแล้ว การหนีขึ้นบกทำให้คุณมีแหล่งอาหารเพิ่ม<br>ขึ้นอีกเป็นจำนวนมากทำให้คุณมีชีวิตรอดต่อไปได้"
    },
    {
        id: 2,
        name: "อิกไทโอสเตกา",
        ...
        info_size: [-2, 35, 160],
        pos_info: [75, 45],
        text_to_next: "คุณมาถูกทางแล้ว ผิวหนังของคุณจะช่วยป้องกัน<br>การระเหยของน้ำออกจากร่างกายทำให้คุณสามารถ<br>หาอาหารอยู่บนบกได้เป็นเวลานาน",
    ...
    },
    {
        ...
        info_size: [-3, 35, 120],
        pos_info: [75, 45],
        text_to_next: "คุณมาถูกทางแล้ว คุณได้มีวิวัฒนาการมาเป็นสัตว์เลือดอุ่น<br>โดยมีการพัฒนาระบบทางเดินอาหาร และทางเดินหายใจ<br>ซึ่งมีประโยชน์ในการล่า",
    ...
    },
    {
        ...
        info_size: [0, 30, 220],
        pos_info: [75, 43],
        text_to_next: "คุณมาถูกทางแล้ว คุณมีวิวัฒนาการมาเป็นสิ่งมีชีวิตที่อาศัย<br>อยู่บนต้นไม้ซึ่งมีการเคลื่อนไหวร่างกายอยู่บ่อยๆ เส้นทางที่<br>คุณเลือกจะทำให้คุณมีระบบระบายความร้อนที่ดี",
...

    {
        ...
        info_size: [-2, 30, 200],
        pos_info: [77, 43],
        text_to_next: "คุณมาถูกทางแล้ว การลงมาใช้ชีวิตอยู่บนพื้นดินจะทำให้<br>ร่างกายของคุณถูกพัฒนาไปเป็นสิ่งมีชีวิตที่เดิน 2 ขา<br>ซึ่งเป็นต้นแบบของมนุษย์ในปัจจุบัน",
    ...
    },
    {
        ...
        info_size: [-2, 20, 350],
        pos_info: [85, 40],
        text_to_next: "คุณมาถูกทางแล้ว คุณมีวิวัฒนาการทางความคิดมากขึ้น<br>ความสามารถในการประดิษฐ์อุปกรณ์ต่างๆขึ้นมาใช้ในชีวิต<br>ประจำวันจะทำให้คุณดำรงชีวิตได้ง่ายขึ้น",
    ...
    },
    {
        ...
        info_size: [-2, 20, 350],
        pos_info: [85, 44],
        text_to_next: "คุณมาถูกทางแล้ว การที่คุณรู้จักเข้าสังคมจะทำให้เกิด<br>วัฒนธรรม และการอยู่รวมกันเป็นกลุ่ม รวมไปถึง<br>เกิดการช่วยเหลือซึ่งกันและกัน",
    ...
    },
    {
        ...
        info_size: [-2, 20, 350],
        pos_info: [85, 42],
        text_to_next: "คุณมาถูกทางแล้ว การคิดค้นหาสมุนไพรเพื่อนำมาทำเป็น<br>ยารักษาโรคช่วยให้ร่างกายของคุณแข็งแรงขึ้น และเป็น<br>การลดความเสี่ยงในการการป่วยตายของเผ่าพันธุ์คุณ",
    ...
    },
    {
        ...
        info_size: [-2, 20, 350],
        pos_info: [85, 40],
        text_to_next: "คุณมาถูกทางแล้ว การสื่อสารเป็นสื่อกลางสำคัญที่<br>จะทำให้สิ่งมีชีวิตทุกชนิดสามารถดำรงชีวิตต่อไปได้",
